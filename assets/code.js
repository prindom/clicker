...
function updateAutoClicker() {
    if (autoClickers > 0) {
        if(autoClickerInt != null) {
            clearInterval(autoClickerInt);
        }
        autoClickerInt = setInterval(function () {
            clicks++;
            updateClicks();
        }, 1000 / autoClickers);
    }
...
function updateMegaClicker() {
    if (megaClickers > 0) {
        if(megaClickerInt != null) {
            clearInterval(megaClickerInt);
        }
        megaClickerInt = setInterval(function () {
            clicks++;
            updateClicks();
        }, 1000 / (megaClickers*15));
    }
